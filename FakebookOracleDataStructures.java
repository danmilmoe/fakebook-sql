...
/*
 * The TaggedPhotoInfo class stores information about users tagged in a
 * particular
 * photo; specifically, it stores a PhotoInfo instance identifying the
 * particular
...
/*
 * The MatchPair class stores information about pairs of users that are tagged
 * in
 * at least one common photo; specifically, it stores one UserInfo instance per
 * user (plus each user's birth year) and a list of PhotoInfo instances
 * identifying
 * the photos in which they are both tagged. Query 5 will use this data
 * structure.
 */
...
/*
 * The FirstNameInfo class stors information about users' first names;
 * specifically,
 * it stores a list of the first names with the most letters, a list of the
 * first
 * names with the fewest letters, and a list of the most commonly-held first
 * names and
...
/*
 * The EventStateInfo class stores information about the states in which events
 * are
 * held; specifically, it stores a list of the states in which the most events
 * are
 * held and the number of events therein held. Query 7 will use this data
 * structure.
 */
...
/*
 * The EventStateInfo class stores the oldest and youngest friend of a
 * particular user,
 * though it does not store information about who that particular user is. Query
 * 8 will
