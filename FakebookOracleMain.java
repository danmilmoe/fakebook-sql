...
public final class FakebookOracleMain {
    // Member Variables
    private static String username = "ianrose"; // replace with your uniqname
    private static String password = "Walloon5"; // replace with your Oracle password (default: eecsclass)
